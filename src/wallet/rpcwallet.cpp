...
extern UniValue importmnemonic(const JSONRPCRequest& request); // in rpcdump.cpp
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    { "wallet",             "importmnemonic",           &importmnemonic,           true,   {"mnemonic","language","mnemonicsalt","rescan"} },
