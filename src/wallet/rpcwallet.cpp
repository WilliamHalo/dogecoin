...
extern UniValue getmnemonic(const JSONRPCRequest& request);
extern UniValue generatemnemonic(const JSONRPCRequest& request);
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    { "wallet",             "importmnemonic",           &importmnemonic,           true,   {"mnemonic","passphrase","label","rescan"} },
    { "wallet",             "getmnemonic",              &getmnemonic,              true,   {} },
    { "util",               "generatemnemonic",         &generatemnemonic,         true,   {"passphrase","strength"} },
};
